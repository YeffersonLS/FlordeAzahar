...
Route::get('admin/products/excel', [\App\Http\Controllers\Admin\T04productosController::class, 'exportProduct'])->name('admin.products.exportProduct');
...
Route::patch('admin/diary/{id}', [\App\Http\Controllers\Admin\T11combosAgendadosController::class, 'update'])->name('admin.diary.update');
